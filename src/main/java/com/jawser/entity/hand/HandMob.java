...
public class HandMob extends EntityMob implements IBossDisplayData {

	public HandMob(World par1World) {
		super(par1World);
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(192.0F);
