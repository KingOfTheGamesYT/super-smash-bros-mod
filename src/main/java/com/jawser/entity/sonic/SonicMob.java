package com.jawser.entity.sonic;
...
public class SonicMob extends EntityMob {

	public SonicMob(World par1World) {
		super(par1World);
        ...
        this.tasks.addTask(12, new EntityAIWatchClosest(this, SonicMob.class, 5.0F));
        ...
        this.tasks.addTask(13, new EntityAIWatchClosest(this, MegamanMob.class, 5.0F));
        ...
        this.tasks.addTask(22, new EntityAIAttackOnCollide(this, SonicMob.class, 0.6D, false));
        ...
        this.tasks.addTask(20, new EntityAIAttackOnCollide(this, MegamanMob.class, 0.6D, false));
        ...
        this.targetTasks.addTask(10, new EntityAINearestAttackableTarget(this, SonicMob.class, 0, true));
