...
public class FoxMob extends EntityMob {

	public FoxMob(World par1World) {
		super(par1World);
        ...
        this.tasks.addTask(12, new EntityAIWatchClosest(this, FoxMob.class, 5.0F));
        ...
        this.tasks.addTask(22, new EntityAIAttackOnCollide(this, FoxMob.class, 0.6D, false));
        ...
        this.targetTasks.addTask(10, new EntityAINearestAttackableTarget(this, FoxMob.class, 0, true));
